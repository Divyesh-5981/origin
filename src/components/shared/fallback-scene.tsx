  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={orbStyle(
          'radial-gradient(circle, hsl(var(--spark) / 0.5), transparent 70%)',
        )}
        animate={
      ...
      <motion.div
        ...
        style={orbStyle(
          'radial-gradient(circle, hsl(var(--ember) / 0.4), transparent 70%)',
        )}
        animate={
          prefersReducedMotion
            ? undefined
        ...
        transition={
          prefersReducedMotion ? undefined : { ...ORB_TRANSITION, duration: 11 }
        }
      />
