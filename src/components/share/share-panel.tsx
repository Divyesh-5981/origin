...
export function SharePanel({
	...
	const handleCopyLink = async () => {
		...
		try {
			...
			setLinkCopied(true);
			window.setTimeout(() => setLinkCopied(false), COPY_RESET_MS);
		} catch {
			setLinkCopied(false);
		}
	};
			...
			<div className="relative z-10 flex flex-col gap-6">
				...
				<div className="flex flex-col gap-3">
					...
					>
						...
						{linkCopied ? (
							<Check
								className="size-4 shrink-0 text-electric-cyan"
								aria-hidden
							/>
						) : (
