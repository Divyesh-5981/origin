...
const STAGES: Stage[] = [
	{
		...
		description:
			"Share a few brief details about your passion to set the stage.",
	},
	{
		id: "ignite",
		label: "02. The Script",
		title: "AI Synthesis",
		description:
			"Our engine weaves your answers into a cohesive, legendary narrative script.",
	},
	{
		id: "weave",
		...
		title: "Visual & Audio",
		description:
			"Your story takes shape as a cinematic poster and dramatic voice narration.",
	},
	{
		id: "share",
...
function ConstellationCanvas() {
	...
	useEffect(() => {
		...
		const render = () => {
			...
			const morphProgress = rawProgress < 0.8 ? 0 : (rawProgress - 0.8) / 0.2; // Quick transition at the end
			...
			particles.forEach((p, idx) => {
				...
				const tx =
					currentTarget.x * (1 - morphProgress) + nextTarget.x * morphProgress;
				const ty =
					currentTarget.y * (1 - morphProgress) + nextTarget.y * morphProgress;
...
export function HowItWorks() {
	...
	return (
		<section
			...
			className="relative mx-auto w-full max-w-6xl scroll-mt-24 px-4 py-32 sm:px-6"
		>
			...
			<div className="relative mb-16 h-80 w-full overflow-hidden rounded-2xl border border-white/10 backdrop-blur-xl">
				<div className="absolute inset-0 bg-linear-to-t from-electric-cyan/5 to-transparent" />
				<ConstellationCanvas />
				<BorderBeam
					size={220}
					duration={8}
					colorFrom="hsl(var(--electric-cyan))"
					colorTo="hsl(var(--ignition-orange))"
				/>
				<BorderBeam
					size={220}
					duration={8}
					delay={4}
					colorFrom="hsl(var(--ignition-orange))"
					colorTo="hsl(var(--electric-cyan))"
				/>
			</div>
