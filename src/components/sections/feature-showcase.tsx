...
const FEATURES: Feature[] = [
	{
		...
		description:
			"A cinematic hero narrative that introduces your journey with blockbuster flair.",
	},
	{
		icon: Clock,
		title: "Interactive Timeline",
		description:
			"Trace your origin from the initial spark to your defining breakthrough.",
	},
	{
		icon: User,
		title: "Hero Dossier",
		description:
			"A sleek, holographic cast profile revealing your strengths and core mission.",
	},
	{
		icon: Image,
		title: "Movie Poster",
		description:
			"An ultra-premium, downloadable poster starring you as the protagonist.",
	},
	{
		icon: Mic,
		title: "Voice Narration",
		description:
			"Experience your story through dramatic, synthesized voice commentary.",
	},
	{
		icon: Share2,
		title: "World Premiere",
		description:
			"Launch your interactive origin site to fans and friends via a shareable link.",
	},
];
