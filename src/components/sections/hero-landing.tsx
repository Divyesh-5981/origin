  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        aria-hidden
      >
        <HeroVisual scrollProgress={prefersReducedMotion ? undefined : scrollYProgress} />
      </motion.div>
      ...
      <div className="pointer-events-none absolute inset-0 z-20 bg-film-grain mix-blend-overlay opacity-30" aria-hidden />
      
      {/* Cinematic Vignette Overlay */}
      <div className="pointer-events-none absolute inset-0 z-20 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(0,0,0,0.9)_100%)]" aria-hidden />
      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Origin transforms a few personal answers into a cinematic, interactive story that feels like the opening sequence of a movie. 
      ...
      >
        <span className="text-[10px] uppercase tracking-widest text-muted-foreground font-medium">Scroll to Discover</span>
