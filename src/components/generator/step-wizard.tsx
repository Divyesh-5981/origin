					...
					<div className="w-full max-w-xl flex flex-col gap-6 relative z-10">
						...
						<div className="flex flex-col gap-2">
							<div className="flex items-center justify-between text-caption text-muted-foreground">
								...
								<span className="font-bold uppercase tracking-wider text-electric-cyan">
									{definition.title}
								</span>
							</div>
							<div
						...
						{draftRecovered ? (
							...
							>
								We couldn&apos;t restore your previous draft, so we started
								fresh.
							</div>
						) : null}
								...
								<div className="flex flex-wrap gap-2">
									{contradictionFields.map((field) => (
										<Button
											...
											onClick={() =>
												setActiveStep(
													clampStepIndex(FIELD_STEP_INDEX[field] ?? 0),
												)
											}
										>
